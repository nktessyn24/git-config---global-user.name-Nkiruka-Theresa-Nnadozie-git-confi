...
## 🔬 Research & interests
- Natural product isolation & structure elucidation (NMR, MS)
- Phytochemistry, bioassays, molecular docking
- Renewable energy & community projects

## 📂 Featured projects
- **Cleome-gynandra-NMR** — NMR assignments and spectra processing scripts  
- **Labubu ($LABU)** — memecoin whitepaper & smart-contract templates (draft)  
